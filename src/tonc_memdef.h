...
*	\brief This is the list of all bit(field) definitions of 
*	memory mapped items.
*	\ingroup grpMemmap
*/
...
#define BLD_BD			0x0020	//!< Blend backdrop
...
#define SDS_ATR0			 0	//!< Direct Sound A to use timer 0
...
#define SSTAT_OFF			 0	//!< Disable sound
#define SSTAT_ON		0x0080	//!< Enable sound. NOTE: enable before using any other sound regs
...
#define DMA_NOW		(DMA_ON  | DMA_AT_NOW)
...
// fills
#define DMA_FILL16	(DMA_NOW | DMA_SRC_FIX | DMA_16)
#define DMA_FILL32	(DMA_NOW | DMA_SRC_FIX | DMA_32)

#define DMA_HDMA	(DMA_ON | DMA_REPEAT | DMA_AT_HBLANK | DMA_DST_RESET)
...
#define IRQ_TM0			0x0008	//!< Catch timer 0 irq
#define IRQ_TM1			0x0010	//!< Catch timer 1 irq
#define IRQ_TM2			0x0020	//!< Catch timer 2 irq
#define IRQ_TM3			0x0040	//!< Catch timer 3 irq
#define IRQ_COM			0x0080	//!< Catch serial comm irq
...
#define IRQ_KEYS		0x1000	//!< Catch key irq
#define IRQ_CART		0x2000	//!< Catch cart irq
