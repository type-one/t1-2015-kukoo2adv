...
//! \name Sound buffers
//\{
#define REG_WAVE			 (vu32*)(REG_BASE+0x0090)	//!< Channel 3 wave buffer
...
#define REG_FIFOA			*(vu32*)(REG_BASE+0x00A0)	//!< DSound A FIFO
#define REG_FIFOB			*(vu32*)(REG_BASE+0x00A4)	//!< DSound B FIFO
//\}
...
#define REG_SIOCNT			*(vu32*)(REG_BASE+0x0128)
...
#define REG_JOYCNT			*(vu16*)(REG_BASE+0x0150)
